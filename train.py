...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='weights/yolov4-p7.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/Chalearn_Month_all.yaml', help='data.yaml path')
    ...
    parser.add_argument('--img-size', nargs='+', type=int, default=[1536, 1536], help='train,test sizes')
    ...
    parser.add_argument('--logdir', type=str, default='runs/train_final/Month/all_e15/p7_ep100_bs24_img1536_scratch',
    ...
    if not opt.evolve:
        ...
        if opt.global_rank in [-1, 0]:
            ...
            # tb_writer = SummaryWriter(log_dir=increment_dir(Path(opt.logdir) / opt.name))  # runs/exp
            tb_writer = SummaryWriter(log_dir=Path(opt.logdir) / opt.name)  # runs/exp
